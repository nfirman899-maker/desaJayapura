...
<head>
    ...
    <title>Cetak Buku Keputusan Kepala Desa - <?= htmlspecialchars($tahun) ?></title>
    <style>
        body {
...
<div class="cover-page">
    <div class="cover-model">MODEL A.2</div>
    <div class="cover-title-area">
        <div class="cover-title-text">
            BUKU DATA KEPUTUSAN KEPALA DESA<br>
...
<div class="kertas">
    <div class="model-text">
        <div style="border: 1px solid #000; padding: 5px 15px; display: inline-block;">MODEL A.2</div>
    </div>
    
    <h1>BUKU DATA KEPUTUSAN KEPALA DESA<br>TAHUN <?= htmlspecialchars($tahun) ?></h1>
    <br>
    ...
    <table>
        ...
        <tbody>
            <?php if (empty($keputusan_list)): ?>
                <tr>
                    <td colspan="6" style="padding: 20px 0;">Tidak ada data keputusan kades untuk tahun <?= htmlspecialchars($tahun) ?>.</td>
                </tr>
            <?php else: ?>
