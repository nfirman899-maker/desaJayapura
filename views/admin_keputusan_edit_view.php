...
<div class="max-w-[1400px] mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-green-800">Edit Buku Data Keputusan Kepala Desa</h1>
        <p class="text-gray-600 mt-2">Perbarui data keputusan kepala desa Model A.2</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-10 overflow-hidden">
        <div class="bg-indigo-800 px-6 py-4">
            <h2 class="text-white font-bold text-lg">Formulir Edit Keputusan Kades</h2>
        </div>
        <div class="p-6">
            <form action="admin_keputusan_edit.php?id=<?= $row['id'] ?>" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="form-group">
                        ...
                        <textarea name="no_tgl_keputusan" rows="3" required><?= htmlspecialchars($row['no_tgl_keputusan']) ?></textarea>
                ...
                <div class="mt-8 flex justify-end gap-3">
                    <a href="admin_keputusan.php?tahun=<?= $row['tahun'] ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-3 px-8 rounded-md transition uppercase text-sm tracking-wider">
                        Batal
                    </a>
